...
const Portfolio = () => {
  ...
  return (
    <>
      <SEO
        title="Digital Marketing Case Studies & Results | Softnics Media"
        description="Explore real digital marketing case studies, campaign performance, ROAS metrics, lead generation results, and growth stories from Softnics Media."
        canonical="https://www.softnicsmedia.com/portfolio"
      />
            ...
            >
              {[
                ...
                },
                {
                  ...
                  icon: (
                    <RocketLaunch sx={{ fontSize: 34, color: "#1e88ff" }} />
                  ),
                  points: [
                ...
                },
                {
                  ...
                  icon: (
                    <ShoppingCart sx={{ fontSize: 34, color: "#1e88ff" }} />
                  ),
                  points: [
            ...
            {[
              {
                ...
                icon: (
                  <TrendingUpIcon sx={{ fontSize: 40, color: "#0066ff" }} />
                ),
          ...
          >
            ...
            >
              <Box sx={{ color: "white" }}>
                ...
                >
                  “We scaled our business with consistent leads and a strong
                  ROAS. One of the best agencies we’ve worked with.”
                </Typography>
              </Box>
            ...
            <Box sx={{ pl: 6 }}>
              {[
                ...
                },
                {
                  name: "GA4 Analytics",
                  icon: (
                    <BarChartIcon sx={{ fontSize: 26, color: "#0066ff" }} />
                  ),
                },
                {
                ...
                },
                {
                  ...
                  icon: (
                    <SettingsIcon sx={{ fontSize: 26, color: "#0066ff" }} />
                  ),
                },
              ].map((tool, i) => (
                <motion.div
