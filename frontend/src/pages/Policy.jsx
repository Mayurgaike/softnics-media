...
const Policy = () => {
  ...
  return (
    <>
      <SEO
        title="Privacy Policy | Softnics Media"
        description="Learn how Softnics Media collects, uses, and protects your personal data."
        canonical="https://www.softnicsmedia.com/privacy-policy"
      />
      <Box
        sx={{
          maxWidth: "900px",
      ...
      >
        ...
        <Box sx={{ lineHeight: 1.8 }}>
          ...
          <Typography>
            Any content, images, or reference material you share for your
            project.
          </Typography>
          ...
          <Typography>
            Softnics Media uses cookies to analyze usage and improve
            performance.
          </Typography>
