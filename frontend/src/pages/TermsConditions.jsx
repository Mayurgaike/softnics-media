...
const TermsConditions = () => {
  ...
  return (
    <>
      <SEO
        title="Terms & Conditions | Softnics Media"
        description="Read the terms and conditions governing the use of Softnics Media services."
        canonical="https://www.softnicsmedia.com/terms-conditions"
      />
      <Box
        sx={{
          maxWidth: "900px",
      ...
      >
        ...
        <Box sx={{ lineHeight: 1.8 }}>
          ...
          <Typography sx={{ mb: 1 }}>
            ...
            content without written permission. Softnics Media does not sell or
            share your content with third parties unless required to provide
            services.
          </Typography>
          ...
          <Typography sx={{ mb: 1 }}>
            ...
            text, and branding materials. Softnics Media is not responsible for
            legal disputes caused by client-submitted assets.
          </Typography>
          ...
          <Typography component="ul" sx={{ pl: 4 }}>
            <li>
              Website Development: 50% advance + 50% after approval/going live
            </li>
          ...
          <Typography sx={{ mb: 3 }}>
            All payments are non-refundable. We provide detailed consultation &
            portfolio examples before project confirmation. Please clarify all
            doubts prior to payment.
          </Typography>
